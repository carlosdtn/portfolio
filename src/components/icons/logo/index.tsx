export default function Logo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      fill="none"
      viewBox="0 0 778 899"
      className="transition duration-300 ease-in-out fill-current hover:fill-gradient"
      {...props}
    >
      <defs>
        <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" style={{ stopColor: '#5433FF' }} />
          <stop offset="50%" style={{ stopColor: '#20BDFF' }} />
          <stop offset="100%" style={{ stopColor: '#A5FECB' }} />
        </linearGradient>
      </defs>
      <path
        fill="#C9CDD1"
        className="group-hover:fill-[url(#gradient)] transition-all duration-500 ease-in-out"
